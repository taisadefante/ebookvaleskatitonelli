      ...
      <Row className="align-items-center">
        ...
        <Col md={8}>
          ...
          >
            ...
            13 anos, especialista em colorimetria e terapeuta capilar, encontrei
            na beleza uma missão: transformar vidas por meio do cuidado,
            autoestima e amor pelo que faço.
          </p>
        </Col>
      </Row>
    </Container>
